...
package rename // import "gosubli.me/margo/rename"
...
// WARN: fix this
var log = golog.New(io.Discard, "", 0)
...
var writeFile = safeWriteFile

func safeWriteFile(filename string, content []byte) error {
